        ...
        <div className="flex items-center space-x-4">
          {token === null ? (
            ...
            <div className="space-x-4">
              ...
              <a
                onClick={logoutUser} 
                className="text-sm font-semibold cursor-pointer text-gray-600 hover:text-gray-900 transition-colors"
              >
                Log Out
              </a>
              <Link
                to={"/dashboard"}
                className="bg-gray-900 text-white text-sm font-bold px-5 py-2.5 rounded-xl hover:bg-indigo-600 hover:shadow-[0_0_20px_rgba(79,70,229,0.4)] transition-all duration-300 active:scale-95"
              >
                Dashboard
              </Link>
            </div>
